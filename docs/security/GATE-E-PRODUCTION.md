...
- `https://tinlance.com` is the sole canonical production origin.
- `https://www.tinlance.com` is treated as a legacy host and redirected to the apex origin by middleware.
...
- the legacy `www` origin does not redirect to the apex origin;
