...
def test_execute_calls_fde_mastery_canonical_route_and_payload(monkeypatch):
    ...
    route = respx.post("https://fde-mastery.internal/v1/triage/org123/cybersecurity").mock(
        return_value=Response(200, json={"request_id": "upstream-request", "client_id": "org123", "domain": "cybersecurity", "result": {"ok": True}})
    )
...
def test_execute_caches_oauth_token_across_requests(monkeypatch):
    ...
    upstream_route = respx.post("https://fde-mastery.internal/v1/triage/org123/finance").mock(return_value=Response(200, json={"request_id": "upstream-request", "client_id": "org123", "domain": "finance", "result": {"ok": True}}))
