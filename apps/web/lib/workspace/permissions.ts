...
const rolePermissions: Record<string, Set<WorkspacePermission>> = {
  "client-admin": new Set(["project:read","assessment:read","evidence:read","evidence:upload","finding:read","report:read","report:download","remediation:read","remediation:create","remediation:update","evaluation:read","evaluation:create","evaluation:execute","comment:write","team:read"]),
  member: new Set(["project:read","assessment:read","evidence:read","evidence:upload","finding:read","report:read","report:download","remediation:read","remediation:update","evaluation:read","evaluation:create","evaluation:execute","comment:write","team:read"]),
  viewer: new Set(["project:read","assessment:read","evidence:read","finding:read","report:read","report:download","remediation:read","evaluation:read","team:read"]),
  owner: new Set(["project:read","project:update","project:transition","assessment:read","assessment:create","assessment:update","assessment:execute","evidence:read","evidence:upload","evidence:verify","finding:read","finding:create","finding:update","finding:publish","finding:verify","report:read","report:create","report:publish","report:download","remediation:read","remediation:create","remediation:update","remediation:verify","remediation:close","evaluation:read","evaluation:create","evaluation:execute","evaluation:manage","workspace:manage","team:read","comment:write"]),
};
