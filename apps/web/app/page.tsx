          ...
          <div className="hero-copy-v2">
            ...
            <div className="hero-actions">
              ...
              <Link className="text-link" href="/sales-engineer">
                Talk to the AI Sales Engineer <ChevronRight size={16} />
              </Link>
        ...
        <div className="container">
          <div className="section-intro-v2">
            <div>
              ...
              <h2>Where strategy ends,<br /><span>engineering begins.</span></h2>
            </div>
      ...
      <section className="section-v2 dark-section">
        <div className="container process-layout">
          <div className="process-sticky">
            ...
            <h2>Embedded.<br /><span>Accountable.</span><br />Shipped.</h2>
            <p>FDE means getting close enough to the real problem to own the engineering outcome. We work in your environment, with your people, against your constraints.</p>
            <Link className="button button-outline" href="/services/forward-deployed-engineering">See the FDE model <ArrowUpRight size={16} /></Link>
          </div>
      ...
      <section className="section-v2 proof-section">
        <div className="container">
          <div className="section-intro-v2 compact">
            <div><p className="kicker">03 / PROOF</p><h2>Built by engineers.<br /><span>Proven in public.</span></h2></div>
            <p>Our own systems are part of the proof. Explore the security products, open-source work, and production platforms behind the Tinlance engineering practice.</p>
          </div>
      ...
      <section className="section-v2 assessment-section">
        <div className="container assessment-card">
          <div>
            ...
            <h2>Bring us the problem.<br /><span>We&apos;ll bring the system.</span></h2>
