        ...
        <div className="container" style={{ maxWidth: "820px" }}>
          ...
          <div className="assessment-card" style={{ marginTop: "4rem" }}>
            <div>
              ...
              <p>
                Bring the workflow, constraints, and target outcome. We can
                assess the technical path with you.
              </p>
            </div>
            <Link
              ...
              href="/contact"
            >
              Start an assessment <ArrowUpRight size={18} />
            </Link>
          </div>
        </div>
      </article>
